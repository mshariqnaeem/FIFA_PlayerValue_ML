d3.csv(interface_test.csv).then(function (data) {
    var fifa= data;
    ...
    for (var i=0; i<filteredPlayers.length; i++) {
        d3.select("tbody").insert("tr").html(
            "<td>" + (filteredPlayers[i]['Id'])+"</td>" +
            "<td>" + (filteredPlayers[i]['Name'])+"</td>" + 
            "<td>" + (filteredPlayers[i]['Age'])+"</td>" +
            "<td>" + (filteredPlayers[i]['Height_CM'])+"</td>" +
            "<td>" + (filteredPlayers[i]['Weight_Kgs'])+"</td>" +
            "<td>" + (filteredPlayers[i]['Positions'])+"</td>" +
            "<td>" + (filteredPlayers[i]['Nationality'])+"</td>" +
            "<td>" + (filteredPlayers[i]['Overall_Rating'])+"</td>" +
            "<td>" + (filteredPlayers[i]['Potential'])+"</td>" +
